...
import {
  LayoutDashboard, ShoppingBag, Package, Folder,
  Users, Tag, Star, BarChart2, ImageIcon, Settings,
} from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-secondary/20">
      ...
      <aside className="w-60 bg-foreground text-background shrink-0 flex flex-col sticky top-0 h-screen overflow-y-auto">
        <div className="p-5 border-b border-background/10">
          <Link href="/" className="font-serif text-xl font-bold text-background">ARISTO</Link>
        ...
        <div className="p-3 border-t border-background/10">
          <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2.5 text-sm text-background/50 hover:text-background transition-colors">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-14 bg-background border-b border-border flex items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-8 h-8 bg-accent/10 rounded-full flex items-center justify-center text-accent text-xs font-bold">A</div>
          </div>
        </header>
